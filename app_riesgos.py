...
if st.sidebar.button(
    "CALCULAR RIESGO"
):  # si el usuario, sí hace click en el botón, entonces se ejecuta el scoring y se muestran los resultados
    # Ejecutar el scoring
    ...
    # Velocimetros (buscó en google streamlit gauge(velocimetro))
